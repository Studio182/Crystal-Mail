...
$fh = fopen("../config/main.inc.php", 'w') or die("Can't open $file for writing: $php_errormsg");
if (-1 == fwrite($fh, $_POST['code'])) { die("Can't write to file:
$php_errormsg"); }
fclose($fh) or die("Can't close $file: $php_errormsg");
echo "<meta http-equiv=\"REFRESH\" content=\"0;url=main-config-editor.php?show=1&message=success\">";
die();
}
if ($_GET['show'] == '') {
echo '<iframe src="main-config-editor.php?show=1" scrolling="no" frameborder="no" height = "95%" width = "100%"></iframe>';
die();
}
...
// print file contents 
 echo "
 <center><h2>Editing main.inc.php</h2>
