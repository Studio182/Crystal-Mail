/*
 ...
 | Copyright (C) 2006-2009, crystalmail Dev, - Switzerland                 |
 ...
 * @contructor
 */
function crystal_list_widget(list, p)
{
  // static contants
  this.ENTER_KEY = 13;
  this.DELETE_KEY = 46;
...
init: function()
{
  if (this.list && this.list.tBodies[0]) {
    ...
    // set body events
    if (this.keyboard) {
      crystal_event.add_listener({event:bw.opera?'keypress':'keydown', object:this, method:'key_press'});
      crystal_event.add_listener({event:'keydown', object:this, method:'key_down'});
    }
  }
},
    ...
    if (bw.iphone || bw.ipad) {
      row.addEventListener('touchstart', function(e) {
        if (e.touches.length == 1) {
          if (!self.drag_row(crystal_event.touchevent(e.touches[0]), this.uid))
            e.preventDefault();
        }
      }, false);
      row.addEventListener('touchend', function(e) {
        if (e.changedTouches.length == 1)
          if (!self.click_row(crystal_event.touchevent(e.changedTouches[0]), this.uid))
            e.preventDefault();
      }, false);
    }
...
drag_column: function(e, col)
{
  if (this.colcount > 1) {
    ...
    this.drag_mouse_start = crystal_event.get_mouse_pos(e);

    crystal_event.add_listener({event:'mousemove', object:this, method:'column_drag_mouse_move'});
    crystal_event.add_listener({event:'mouseup', object:this, method:'column_drag_mouse_up'});
...
drag_row: function(e, id)
{
  ...
  var evtarget = crystal_event.get_target(e),
  ...
  // accept right-clicks
  if (crystal_event.get_button(e) == 2)
    return true;
  ...
  if (!this.in_selection_before) {
    var mod_key = crystal_event.get_modifier(e);
  ...
  if (this.draggable && this.selection.length) {
    this.drag_start = true;
    this.drag_mouse_start = crystal_event.get_mouse_pos(e);
    crystal_event.add_listener({event:'mousemove', object:this, method:'drag_mouse_move'});
    crystal_event.add_listener({event:'mouseup', object:this, method:'drag_mouse_up'});
    if (bw.iphone || bw.ipad) {
      crystal_event.add_listener({event:'touchmove', object:this, method:'drag_mouse_move'});
      crystal_event.add_listener({event:'touchend', object:this, method:'drag_mouse_up'});
    }
...
click_row: function(e, id)
{
  var now = new Date().getTime(),
    mod_key = crystal_event.get_modifier(e),
    evtarget = crystal_event.get_target(e),
    tagname = evtarget.tagName.toLowerCase();
...
key_press: function(e)
{
  ...
  var keyCode = crystal_event.get_keycode(e);
  var mod_key = crystal_event.get_modifier(e);
...
key_down: function(e)
{
  switch (crystal_event.get_keycode(e)) {
    case 27:
      if (this.drag_active)
    ...
    case 109:
    case 32:
      if (!crystal_event.get_modifier(e) && this.focused)
        return crystal_event.cancel(e);
...
drag_mouse_move: function(e)
{
  ...
  if (e.type == 'touchmove') {
    if (e.changedTouches.length == 1)
      e = crystal_event.touchevent(e.changedTouches[0]);
    else
      return crystal_event.cancel(e);
  }
  ...
  if (this.drag_start) {
    ...
    var m = crystal_event.get_mouse_pos(e);
...
drag_mouse_up: function(e)
{
  ...
  crystal_event.remove_listener({event:'mousemove', object:this, method:'drag_mouse_move'});
  crystal_event.remove_listener({event:'mouseup', object:this, method:'drag_mouse_up'});
  
  if (bw.iphone || bw.ipad) {
    crystal_event.remove_listener({event:'touchmove', object:this, method:'drag_mouse_move'});
    crystal_event.remove_listener({event:'touchend', object:this, method:'drag_mouse_up'});
  }
...
column_drag_mouse_move: function(e)
{
  if (this.drag_start) {
    // check mouse movement, of less than 3 pixels, don't start dragging
    var i, m = crystal_event.get_mouse_pos(e);
  ...
  if (this.col_drag_active && this.col_draglayer) {
    var i, cpos = 0, pos = crystal_event.get_mouse_pos(e);
...
column_drag_mouse_up: function(e)
{
  ...
  crystal_event.remove_listener({event:'mousemove', object:this, method:'column_drag_mouse_move'});
  crystal_event.remove_listener({event:'mouseup', object:this, method:'column_drag_mouse_up'});
  // remove temp divs
  this.del_dragfix();
...
crystal_list_widget.prototype.addEventListener = crystal_event_engine.prototype.addEventListener;
crystal_list_widget.prototype.removeEventListener = crystal_event_engine.prototype.removeEventListener;
crystal_list_widget.prototype.triggerEvent = crystal_event_engine.prototype.triggerEvent;
