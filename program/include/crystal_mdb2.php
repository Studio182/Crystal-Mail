...
/*
 ...
 | Copyright (C) 2005-2009, Crystal Mail Dev. - United States                 |
...
class crystal_mdb2
{
    ...
    private function _sqlite_prepare()
    {
        ...
        sqlite_create_function($this->db_handle->connection,
            'from_unixtime', 'crystal_sqlite_from_unixtime');
        sqlite_create_function($this->db_handle->connection,
            'unix_timestamp', 'crystal_sqlite_unix_timestamp');
        sqlite_create_function($this->db_handle->connection,
            'now', 'crystal_sqlite_now');
        sqlite_create_function($this->db_handle->connection,
            'md5', 'crystal_sqlite_md5');
    }
