...
/*
 ...
 | Copyright (C) 2008-2009, Crystal Mail Dev. - Switzerland                 |
...
foreach ($crit_opts as $optname => $optval) {
    if ($optval != ini_get($optname)) {
        die("ERROR: Wrong '$optname' option value. Read REQUIREMENTS section in INSTALL file or use crystalmail Installer, please!");
    }
}

// application constants
define('cmail_VERSION', '1.3');
